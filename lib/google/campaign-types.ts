...
export const OBJECTIVE_CONFIGS: Record<string, GoogleObjectiveConfig> = {
  PERFORMANCE_MAX: {
    ...
    allowedBiddingStrategies: ["MAXIMIZE_CONVERSIONS", "MAXIMIZE_CONVERSION_VALUE"],
  ...
  SHOPPING: {
    ...
    allowedBiddingStrategies: ["MAXIMIZE_CONVERSIONS", "TARGET_ROAS", "MANUAL_CPC", "ENHANCED_CPC", "MAXIMIZE_CONVERSION_VALUE"],
    defaultBiddingStrategy: "MAXIMIZE_CONVERSIONS",
    conversionTrackingRequired: true,
